...
export const useCharacterMovement = (containerRef, onFirstMove, onFirstEmote) => {
  ...
  useEffect(() => {
    ...
    const handleTouchStart = (e) => {
      // Prevent default to stop scrolling while interacting with character
      ...
      /* touchInterval = setInterval(() => {
        // This is handled by the loop checking keysPressed, 
        // we just need to keep the key in the set
      }, 16); */
    };
    ...
    // Need to track touch position updates to change direction if user drags finger across character
